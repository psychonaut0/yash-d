...
export default function Tile() {
  return (
    <div className="relative group cursor-pointer active:translate-y-1 transition-all active:opacity-50">
      ...
      <div className="flex group-hover:shadow-2xl w-full h-full border-2  px-6  py-4 rounded-xl border-primary  bg-dark relative z-10 flex-col items-center space-y-2 ">
